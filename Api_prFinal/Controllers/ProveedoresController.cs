...
namespace Api_prFinal.Controllers
{
    ...
    public class ProveedoresController : ControllerBase
    {
        ...
        {
            if (id != proveedores.id_proveedores)
            {
                return BadRequest();
            }
        ...
        public async Task<ActionResult<Proveedores>> PostProveedores(Proveedores proveedores)
        {
            ...
            return CreatedAtAction("GetProveedores", new { id = proveedores.id_proveedores }, proveedores);
        }
        ...
        {
            return _context.Proveedores.Any(e => e.id_proveedores == id);
        }
    }
}
